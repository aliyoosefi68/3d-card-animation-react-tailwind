    ...
    <div style={{ perspective: 2000 }}>
      ...
      >
        ...
        <p className="max-w-[300px] text-[#000] mb-6">
          Taking the classic look heritag Nike Running into realm,the Nike Air
          Max Pre-Day bring you a fast-paced look that's ready for todays world.
        </p>
        <div className="flex items-center gap-x-[20px] mb-12">
          ...
          <div className="text-[24px] font-bold text-[#000]">$495.00</div>
        </div>
        ...
        >
          <img src={NikeImg} alt="shoe" draggable="false" />
        </motion.div>
      </motion.div>
    </div>
  );
